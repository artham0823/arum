;(function (window) {
  ...
  let texts = ['TAP EN NDEKDI AE','JOK LALI', 'GAE LANDSCAPE MODE',
     'HALO BANG', 'DELOK EN IKI', 'KATA IKI', 'ONOK SENG ANEH',
      'AGE PENCET EN', 'GA GOROI AKU KOK', 'PENCET NEH',
       'LOH LOH OJOK KESEL SEK', 'TAPI IKI NCEN ONOK SENG ANEH KOK',
        'JANJI AU', 'TERAKHIR IKI KOK', 'PENCET NEH HAHAHA', 'AYO JOK LEMES',
         'AYOLA BANG', 'SITIK NGKAS KOK', 'AYO DECK',
          'IKI WS TERAKHIR KOK', 'YOWESLA', 'GWS :V', 'AWOKWOK', 'PINCANG REK',
           'HEHEHE', 'BYE', 'MAAP BANG :V',
            'PAS IKO LALI GA NGUCAPNO PAS WM ULTAH, HEHEHE']
